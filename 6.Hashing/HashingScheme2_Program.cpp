//Implementing hashing using Quadratic probing
#include <bits/stdc++.h>
#include<chrono>
using namespace std;
using namespace std::chrono;

//Here multiplicative hash function is used(in other program, modulo was used)
long long int hash_func(long long int key)
{
    float h,A=0.023798;//A is random constant between 0 and 1
    h=((key*A));
    h=h-(floor(h));
    h*=100000;
    return h;
...
int main()
{
    cout<<"**Hashing Implementation using Quadratic probing(Multiplicative hash function)**\nHash Table size: 100000\n";
